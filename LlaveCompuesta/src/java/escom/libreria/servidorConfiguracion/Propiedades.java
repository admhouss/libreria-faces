...
public class Propiedades implements Serializable {
    ...
    private ServidorCorreoConf servidorCorreoConf;
    ...
    public ServidorCorreoConf getServidorCorreoConf() {
        return servidorCorreoConf;
    }

    public void setServidorCorreoConf(ServidorCorreoConf servidorCorreoConf) {
        this.servidorCorreoConf = servidorCorreoConf;
    }
    ...
    public String toString() {
        return "administracion.Propiedades[id=" + id + "]";
    }
