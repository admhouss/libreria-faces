...
import escom.libreria.servidorConfiguracion.ejb.PropiedadesFacade;
...
public class PropiedadesController {
    ...
    @EJB private escom.libreria.servidorConfiguracion.ejb.PropiedadesFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/configuracion").getString("PropiedadesCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/configuracion").getString("PropiedadesUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/configuracion").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/configuracion").getString("PropiedadesDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/configuracion").getString("PersistenceErrorOccured"));
        }
    }
