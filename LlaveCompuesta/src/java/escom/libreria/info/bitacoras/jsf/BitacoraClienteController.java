...
public class BitacoraClienteController  implements Serializable{
    ...
    @EJB private escom.libreria.info.bitacoras.ejb.BitacoraClienteFacade ejbFacade;
    ...
    public static class BitacoraClienteControllerConverter implements Converter {
        ...
        escom.libreria.info.bitacoras.BitacoraClientePK getKey(String value) {
            escom.libreria.info.bitacoras.BitacoraClientePK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new escom.libreria.info.bitacoras.BitacoraClientePK();
        ...
        String getStringKey(escom.libreria.info.bitacoras.BitacoraClientePK value) {
