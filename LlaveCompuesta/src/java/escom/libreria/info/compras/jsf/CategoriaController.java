...
import escom.libreria.info.compras.ejb.CategoriaFacade;
...
public class CategoriaController implements Serializable{
    ...
    @EJB private CategoriaFacade ejbFacade;
    ...
    public List<Categoria> getListAllCategoria(){
    ...
    public String prepareView(Categoria p) {
        current = p;//(Categoria)getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(("Categoria creada Satisfactoriamente"));
            return prepareView(current);
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ("Error al crear la categoria "));
            return null;
        }
    }

    public String prepareEdit(Categoria p) {
        current =p;// (Categoria)getItems().getRowData();
        //selectedItemIndex = pagination.getPageFirstItem() + getItems().getRowIndex();
        return "Edit";
    }
    ...
    public String update() {
        try {
            ...
            JsfUtil.addErrorMessage(e, ("Error al actualizar la categoria"));
            return null;
        }
    }

    public String destroy(Categoria p) {
        current = p;//(Categoria)getItems().getRowData();
        getFacade().remove(current);
        //selectedItemIndex = pagination.getPageFirstItem() + getItems().getRowIndex();
        //performDestroy();
        //recreateModel();
        JsfUtil.addSuccessMessage("Categoria eliminada satisfactoriamente");
    ...
    private void performDestroy() {
        try {
            getFacade().remove(current);
            JsfUtil.addSuccessMessage(("CategoriaDeleted"));
        } catch (Exception e) {
