...
import escom.libreria.info.compras.ejb.EstadoFacade;
...
public class EstadoController implements Serializable{
    ...
    @EJB private EstadoFacade ejbFacade;
    ...
    public String prepareView(Estado p) {
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(("Estado creado Satisfactoriamente"));
            return prepareView(current);
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ("Error al crear Estado"));
            return null;
        }
    }

    public String prepareEdit(Estado p) {
        current =p; //(Estado)getItems().getRowData();
        //selectedItemIndex = pagination.getPageFirstItem() + getItems().getRowIndex();
        return "Edit";
    }
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(("Estado actualizado Satisfactoriamente"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ("Error al actualizar el Estado"));
            return null;
        }
    }
    ...
    public String destroy(Estado p) {
        ...
        //recreateModel();
        ejbFacade.remove(p);
        JsfUtil.addSuccessMessage("Estado Eliminado satisfactoriamente");
        return "List";
    }
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(("EstadoDeleted"));
        } catch (Exception e) {
