...
public class UsuarioadministrativoController {
    ...
    @EJB private escom.libreria.info.administracion.ejb.UsuarioadministrativoFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Usuarioadministrativo)getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/administracion").getString("UsuarioadministrativoCreated"));
            return prepareCreate();
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/administracion").getString("PersistenceErrorOccured"));
            return null;
        }
    }
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/administracion").getString("UsuarioadministrativoUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/administracion").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/administracion").getString("UsuarioadministrativoDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/administracion").getString("PersistenceErrorOccured"));
        }
    }
