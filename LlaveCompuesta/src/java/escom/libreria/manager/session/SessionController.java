...
/*
 ...
 public class SessionController implements Filter {
	...
	//if (debug) log("SessionController:DoBeforeProcessing");
	...
	throws IOException, ServletException {
	//if (debug) log("SessionController:DoAfterProcessing");
	...
	//if (debug) log("SessionController:doFilter()");
   ...
   if(session==null )System.out.println("Session Invalid");
        ...
        if (session==null ) {//if we have no session

                try {

                    String url=request.getServerName()+":"+request.getServerPort()+request.getServletContext().getContextPath()+"/";
	...
	if (filterConfig != null) {
	    if (debug) { 
		log("SessionController:Initializing filter");
	    }
	}
    }
	...
	StringBuffer sb = new StringBuffer("SessionController(");
