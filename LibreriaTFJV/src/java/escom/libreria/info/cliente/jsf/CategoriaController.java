...
public class CategoriaController {
    ...
    @EJB private escom.libreria.info.cliente.ejb.CategoriaFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Categoria").getString("CategoriaCreated"));
    ...
    private void performDestroy() {
        try {
            getFacade().remove(current);
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Categoria").getString("CategoriaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Categoria").getString("PersistenceErrorOccured"));
        }
    }
