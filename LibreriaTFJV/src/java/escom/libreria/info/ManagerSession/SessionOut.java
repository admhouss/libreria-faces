...
package escom.libreria.info.ManagerSession;
 ...
 * @author xxx
 */
public class SessionOut implements Filter {
	...
	if (debug) log("SessionOut:DoBeforeProcessing");
	...
	*/
	...
	throws IOException, ServletException {
	if (debug) log("SessionOut:DoAfterProcessing");
...
*/
	...
	if (filterConfig != null) {
	    if (debug) { 
		log("SessionOut: Initializing filter");
	    }
	}
    }
	...
	if (filterConfig == null) return ("SessionOut()");
	StringBuffer sb = new StringBuffer("SessionOut(");
	...
	public void setParameter(String name, String []values) {
	    if (debug) System.out.println("SessionOut::setParameter(" + name + "=" + values + ")" + " localParams = "+ localParams);
	...
	public String getParameter(String name) {
	    if (debug) System.out.println("SessionOut::getParameter(" + name + ") localParams = " + localParams);
	    if (localParams == null)
	...
	public String[] getParameterValues(String name) {
	    if (debug) System.out.println("SessionOut::getParameterValues(" + name + ") localParams = " + localParams);
	    if (localParams == null)
	...
	public Enumeration getParameterNames() {
	    if (debug) System.out.println("SessionOut::getParameterNames() localParams = " + localParams);
	    if (localParams == null)
	...
	public Map getParameterMap() {
	    if (debug) System.out.println("SessionOut::getParameterMap() localParams = " + localParams);
	    if (localParams == null)
